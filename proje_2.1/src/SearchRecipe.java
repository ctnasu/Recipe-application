...
public class SearchRecipe {
    ...
    private Map<String, Double> userIngredients; // New field to hold user input for ingredients

    public SearchRecipe(Connection connection, JPanel recipePanel) {
        this.connection = connection;
        this.recipePanel = recipePanel;
        this.userIngredients = new HashMap<>(); // Initialize the userIngredients map

    }
    public void setUserIngredients(Map<String, Double> userIngredients) {
        this.userIngredients = userIngredients; // Method to set user input ingredients
    }
